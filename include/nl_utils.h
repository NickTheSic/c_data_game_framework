...
//LOG("Point X: %f, Y: %f was%s contained in origin X: %f, Y: %f, Size X: %f, Y: %f", point.x, point.y, ContainedWithin ? "" : " not", origin.x, origin.y, origin.x+size.x, origin.y+size.y);
